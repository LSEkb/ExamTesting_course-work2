...
class JavaQuestionRepositoryTest {
    ...
    JavaQuestionRepository underTest = new JavaQuestionRepository();
    ...
    @BeforeEach
    void beforeEach() {
        questions = new HashSet<>(List.of(question1, question2, question3));
    }

    @Test
    void add_addedRepeatedQuestionsAndAnswer_thrownQuestionAlreadyAddedException() {
        underTest.add(question1);
        assertThrows(QuestionAlreadyAddedException.class, () -> underTest.add(question1));
    }

    @Test
    void add_addedNewQuestionsAndAnswer_questionsAddedAndReturn() {
